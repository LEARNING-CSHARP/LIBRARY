namespace MyApplication
{
	public partial class MainForm : System.Windows.Forms.Form
	{
		...
		// **************************************************
		private Admin.CreateResourceForm createResourceForm;

		private void CreateResourceToolStripMenuItem_Click(object sender, System.EventArgs e)
		{
			if (createResourceForm == null || createResourceForm.IsDisposed)
			{
				createResourceForm = new Admin.CreateResourceForm
				{
					MdiParent = this,
				};
			}

			createResourceForm.Show();
		}
		// **************************************************

		// **************************************************
		private Admin.ResourceListForm resourceListForm;

		private void SearchResourceToolStripMenuItem_Click(object sender, System.EventArgs e)
		{
			if (resourceListForm == null || resourceListForm.IsDisposed)
			{
				resourceListForm = new Admin.ResourceListForm
				{
					MdiParent = this,
				};
			}

			resourceListForm.Show();
		}
		// **************************************************
